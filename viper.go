...
func Reset() {
	v = New()
	SupportedExts = []string{"json", "hjson", "toml", "yaml", "yml", "hcl"}
...
var SupportedExts = []string{"json", "hjson", "toml", "yaml", "yml", "properties", "props", "prop", "hcl"}
...
func (v *Viper) getKeyValueConfig() error {
	if RemoteConfig == nil {
		return RemoteConfigError("Enable the remote features by doing a blank import of the viper/remote package: '_ github.com/landonb/viper/remote'")
	}
